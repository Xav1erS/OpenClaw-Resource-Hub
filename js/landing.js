          ...
          <section class="grid gap-10 lg:grid-cols-[1.2fr,0.8fr] lg:items-end">
            ...
            <div class="grid gap-3 sm:grid-cols-3 lg:grid-cols-1 xl:grid-cols-3">
              <article class="rounded-3xl border border-white/10 bg-white/5 p-5">
                <div class="text-sm text-slate-400">${text.statLabels.structure}</div>
                <div class="mt-2 text-[clamp(1.75rem,3vw,2.5rem)] font-semibold leading-tight text-white break-words">${text.statValues.structure}</div>
              </article>
              <article class="rounded-3xl border border-white/10 bg-white/5 p-5">
                <div class="text-sm text-slate-400">${text.statLabels.language}</div>
                <div class="mt-2 text-[clamp(1.75rem,3vw,2.5rem)] font-semibold leading-tight text-white break-words">${text.statValues.language}</div>
              </article>
              <article class="rounded-3xl border border-white/10 bg-white/5 p-5">
                <div class="text-sm text-slate-400">${text.statLabels.goal}</div>
                <div class="mt-2 text-[clamp(1.75rem,3vw,2.5rem)] font-semibold leading-tight text-white break-words">${text.statValues.goal}</div>
              </article>
            </div>
          </section>
          ...
          <section class="mt-10 grid gap-6 lg:grid-cols-[1.2fr,0.8fr]">
            ...
            <aside class="rounded-[28px] border border-white/10 bg-slate-950/50 p-5">
              ...
              <div class="mt-6 grid gap-3">
                <a href="/pages/release-notes.html" class="rounded-2xl border border-white/10 bg-white/[0.03] px-4 py-3 text-sm text-slate-200 transition hover:border-orange-400/40 hover:text-white">${text.releaseLinks.notes}</a>
                <a href="/pages/task-library.html" class="rounded-2xl border border-white/10 bg-white/[0.03] px-4 py-3 text-sm text-slate-200 transition hover:border-orange-400/40 hover:text-white">${text.releaseLinks.library}</a>
                <a href="/pages/command-center.html" class="rounded-2xl border border-white/10 bg-white/[0.03] px-4 py-3 text-sm text-slate-200 transition hover:border-orange-400/40 hover:text-white">${text.releaseLinks.command}</a>
              </div>
            </aside>
          </section>
